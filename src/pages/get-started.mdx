...
<Tabs items={["npm", "yarn", "pnpm"]} defaultIndex={1}>
  <Tab>```bash npm i react react-dom next nextra ```</Tab>
  <Tab>```bash yarn add react react-dom next nextra ```</Tab>
  <Tab>```bash pnpm i react react-dom next nextra ```</Tab>
</Tabs>

2. Install the docs theme

<Tabs items={["npm", "yarn", "pnpm"]} defaultIndex={1}>
  <Tab>```bash npm i nextra-theme-docs ```</Tab>
  <Tab>```bash yarn add nextra-theme-docs ```</Tab>
  <Tab>```bash pnpm i nextra-theme-docs ```</Tab>
</Tabs>
